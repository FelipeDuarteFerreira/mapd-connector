  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem118 = null;
          elem118 = new ttypes.TGpuSpecification();
          elem118.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem126 = null;
          elem126 = new ttypes.THardwareInfo();
          elem126.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem142 = null;
          elem142 = new ttypes.TMemoryData();
          elem142.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem150 = null;
          elem150 = new common_ttypes.TTypeInfo();
          elem150.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem166 = null;
          elem166 = new ttypes.TColumnType();
          elem166.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem174 = null;
          elem174 = new ttypes.TColumnRange();
          elem174.read(input);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem181 = null;
          elem181 = new ttypes.TDictionaryGeneration();
          elem181.read(input);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem188 = null;
          elem188 = new ttypes.TTableGeneration();
          elem188.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem213 = null;
          elem213 = new ttypes.TDataBlockPtr();
          elem213.read(input);
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i221 = 0; _i221 < _size216; ++_i221)
        {
          var key222 = null;
          var val223 = null;
          key222 = input.readI32();
          val223 = new ttypes.TRawRenderPassDataResult();
          val223.read(input);
          ...
          for (var _i239 = 0; _i239 < _size234; ++_i239)
          {
            ...
            for (var _i247 = 0; _i247 < _size242; ++_i247)
            {
              ...
              for (var _i255 = 0; _i255 < _size250; ++_i255)
              {
                ...
                {
                  var elem264 = null;
                  elem264 = new ttypes.TRenderDatum();
                  elem264.read(input);
                  val257.push(elem264);
                }
                input.readListEnd();
