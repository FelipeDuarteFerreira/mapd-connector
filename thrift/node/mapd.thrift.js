  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem296 = null;
          elem296 = new ttypes.TServerStatus();
          elem296.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem352 = null;
          elem352 = new ttypes.TNodeMemoryInfo();
          elem352.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem492 = null;
          elem492 = new ttypes.TGeoFileLayerInfo();
          elem492.read(input);
...
MapDProcessor.prototype.process_switch_database = function(seqid, input, output) {
  ...
  if (this._handler.switch_database.length === 2) {
    Q.fcall(this._handler.switch_database, args.session, args.dbname)
      .then(function(result) {
...
MapDProcessor.prototype.process_get_session_info = function(seqid, input, output) {
  ...
  if (this._handler.get_session_info.length === 1) {
    Q.fcall(this._handler.get_session_info, args.session)
      .then(function(result) {
...
MapDProcessor.prototype.process_share_dashboard = function(seqid, input, output) {
  ...
  if (this._handler.share_dashboard.length === 6) {
    Q.fcall(this._handler.share_dashboard, args.session, args.dashboard_id, args.groups, args.objects, args.permissions, args.grant_role)
      .then(function(result) {
...
MapDProcessor.prototype.process_create_table = function(seqid, input, output) {
  ...
  if (this._handler.create_table.length === 5) {
    Q.fcall(this._handler.create_table, args.session, args.table_name, args.row_desc, args.file_type, args.create_params)
      .then(function(result) {
...
MapDProcessor.prototype.process_import_geo_table = function(seqid, input, output) {
  ...
  if (this._handler.import_geo_table.length === 6) {
    Q.fcall(this._handler.import_geo_table, args.session, args.table_name, args.file_name, args.copy_params, args.row_desc, args.create_params)
      .then(function(result) {
...
MapDProcessor.prototype.process_get_layers_in_geo_file = function(seqid, input, output) {
  ...
  if (this._handler.get_layers_in_geo_file.length === 3) {
    Q.fcall(this._handler.get_layers_in_geo_file, args.session, args.file_name, args.copy_params)
      .then(function(result) {
...
MapDProcessor.prototype.process_check_table_consistency = function(seqid, input, output) {
  ...
  if (this._handler.check_table_consistency.length === 2) {
    Q.fcall(this._handler.check_table_consistency, args.session, args.table_id)
      .then(function(result) {
